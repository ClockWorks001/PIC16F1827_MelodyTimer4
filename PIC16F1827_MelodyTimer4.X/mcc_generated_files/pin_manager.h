...
#define P2B_PORT               RA6
#define P2B_SetHigh()    do { LATA6 = 1; } while(0)
#define P2B_SetLow()   do { LATA6 = 0; } while(0)
#define P2B_Toggle()   do { LATA6 = ~LATA6; } while(0)
#define P2B_GetValue()         RA6
#define P2B_SetDigitalInput()    do { TRISA6 = 1; } while(0)
#define P2B_SetDigitalOutput()   do { TRISA6 = 0; } while(0)

// get/set P2A aliases
#define P2A_TRIS               TRISA7
#define P2A_LAT                LATA7
#define P2A_PORT               RA7
#define P2A_SetHigh()    do { LATA7 = 1; } while(0)
#define P2A_SetLow()   do { LATA7 = 0; } while(0)
#define P2A_Toggle()   do { LATA7 = ~LATA7; } while(0)
#define P2A_GetValue()         RA7
#define P2A_SetDigitalInput()    do { TRISA7 = 1; } while(0)
#define P2A_SetDigitalOutput()   do { TRISA7 = 0; } while(0)
