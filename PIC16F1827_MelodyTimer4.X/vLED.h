...
#define LED3_ON()		IO_RB1_SetHigh()
#define LED3_OFF()		IO_RB1_SetLow()

#define LED3min_ON()            IO_RB3_SetHigh()
#define LED3min_OFF()           IO_RB3_SetLow()
#define LED5min_ON()            IO_RB2_SetHigh()
#define LED5min_OFF()           IO_RB2_SetLow()
#define LED10min_ON()           IO_RB1_SetHigh()
#define LED10min_OFF()          IO_RB1_SetLow()
enum eMenu_LED {
